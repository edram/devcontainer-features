...
check "codex is installed in /usr/local/bin" test "$(command -v codex)" = /usr/local/bin/codex
check "codex install directory is persisted" test "$CODEX_INSTALL_DIR" = /usr/local/bin
check "codex home is persisted" test "$CODEX_HOME" = /usr/local/share/codex
