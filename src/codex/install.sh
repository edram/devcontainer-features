...
RELEASE="${VERSION:-${CODEX_RELEASE:-latest}}"
NON_INTERACTIVE="${CODEX_NON_INTERACTIVE:-1}"

BIN_DIR="${CODEX_INSTALL_DIR:-/usr/local/bin}"
BIN_PATH="$BIN_DIR/codex"
CODEX_HOME_DIR="${CODEX_HOME:-/usr/local/share/codex}"
